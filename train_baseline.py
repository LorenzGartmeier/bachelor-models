...
if os.path.exists(os.path.join('model', 'sceneContentApproximator.weights.h5')):
    # load the model
    sceneContentApproximator.build(input_shape=(batch_size, resize_height, resize_width, 1)) 
    sceneContentApproximator.load_weights(os.path.join('baseline_model', 'sceneContentApproximator.weights.h5'))
else:
    ...
    # save the model
    sceneContentApproximator.save_weights(os.path.join('baseline_model', 'sceneContentApproximator.weights.h5'))
